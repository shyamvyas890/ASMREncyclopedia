...
const NotificationsDropdownComponent = ()=>{
    ...
    const handleNewNotification = (notification)=>{
        ...
        Promise.all(promises).then(resolvedPromises=>{
            ...
            if(notificationsElements.length===10){
    ...
    const fetchNotifications = async (e)=>{
        ...
        const notificationsArr = (await axiosRequest(3,2,"notifications", {UserId: username.userIdOfCurrentUser, Dropdown:true})).data;
    ...
    return (
        <div style={{position:"relative", width:"300px"}}>
            <button onClick= {()=>{setShowDropdown(prev=>!prev)}}style = {{marginLeft:"15rem", cursor:"pointer", borderRadius:"50%"}}>
                ...
                {
                    showDropdown &&
                        <div style={{ position: "absolute", top: "calc(100% - 5px)", right: "0px", width: "200px", maxHeight: "200px", overflowY: "auto", backgroundColor: "black", boxShadow: "0px 8px 16px 0px rgba(0,0,0,0.2)", zIndex: 1 }}>
